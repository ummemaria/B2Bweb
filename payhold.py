...
def payment_hold(page, current_balance, expected_data):
    ...
    if new_balance != expected_new_balance:
        error_message = f"Balance verification passeed! Expected BDT {expected_new_balance}, but got BDT {new_balance}"
        print(error_message) 
    else:
